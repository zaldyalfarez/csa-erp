...
@section('content')
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('exports.inbound.pdf', array_merge(request()->query(), ['filename' => 'laporan-barang-masuk-' . now()->format('Ymd-His') . '.pdf'])) }}" download="laporan-barang-masuk.pdf"
            ...
            <a href="{{ route('exports.inbound.excel', array_merge(request()->query(), ['filename' => 'laporan-barang-masuk-' . now()->format('Ymd-His') . '.xlsx'])) }}"
