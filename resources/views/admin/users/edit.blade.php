        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-4">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700 font-bold">
                            Akun ini memiliki sesi kasir yang masih aktif (OPEN).
                        </p>
                        <p class="text-xs text-red-600 mt-1">
                            Harap tutup sesi kasir terlebih dahulu sebelum mengubah data penugasan atau profil pengguna untuk menjaga integritas data transaksi.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                <button type="submit" 
                    ...
                    class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-5 py-2 rounded-lg transition disabled:bg-gray-400 disabled:cursor-not-allowed">
                    Simpan Perubahan
                </button>
