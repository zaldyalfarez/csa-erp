...
<div class="space-y-4">
    ...
    <div class="flex items-center gap-2 flex-wrap">
        ...
        <a href="{{ route('exports.expenses.pdf', array_merge(request()->query(), ['filename' => 'laporan-pengeluaran-' . now()->format('Ymd-His') . '.pdf'])) }}" download="laporan-pengeluaran.pdf"
        ...
        <a href="{{ route('exports.expenses.excel', array_merge(request()->query(), ['filename' => 'laporan-pengeluaran-' . now()->format('Ymd-His') . '.xlsx'])) }}"
